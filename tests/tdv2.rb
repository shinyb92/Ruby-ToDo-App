...
class List
  ...
  def all_complete
    @all_tasks.each do |task|
      task.description = task.description + ' --Complete!' 
  ...
  def all_incomplete 
    @all_tasks.each do |task| 
      task.description = task.description.sub!(" --Complete!", "")
    end 
  end 
...
when 'all complete' 
  my_list.all_complete 
  my_list.save 
when 'all incomplete' 
  my_list.all_incomplete
  my_list.save 
when 'commands' 
  ...
  puts " 'All Complete'  : Marks all current tasks -- Complete! "
  puts " 'All incomplete': Marks all current tasks as incomplete. "
